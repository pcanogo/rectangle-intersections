...
public class IntersectRectangleTest {
	...
	public void testParentIndexes() {
		IntersectRectangle rect1 = case1();
		assertEquals(indexes, rect1.getParentsIndex());
		clearCase();

		IntersectRectangle rect2 = case2();
	...
	public void testChildOf() {
		...
		assertFalse(rect2.isChildOf(parent2));
		clearCase();
	}
	...
	private IntersectRectangle case1() {
		parents.add(parent1);
		parents.add(parent3);
		indexes.add(1);
		indexes.add(3);
	...
	private IntersectRectangle case2() {
		parents.add(parent1);
		parents.add(parent3);
		parents.add(parent4);
		indexes.add(1);
